...
urlpatterns = [
    ...
    url('shop/(?P<id>\w+)/$', views.products_details.as_view(), name='product_details'),
    url('shop', views.products_list.as_view(), name='shop'),
    url(r"guide", views.suppliers_list.as_view(), name='guide')
