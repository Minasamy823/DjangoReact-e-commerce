import { ComponentVariablesPrepared, ComponentSlotStylesInput, ComponentSlotStylesPrepared, FontFace, SiteVariablesInput, SiteVariablesPrepared, ThemeComponentStylesInput, ThemeComponentStylesPrepared, ThemeComponentVariablesInput, ThemeComponentVariablesPrepared, ThemeInput, ThemePrepared, StaticStyle, ThemeIcons, ComponentSlotStyle, ThemeAnimation } from '../themes/types';
 ...
 */
export declare const mergeComponentStyles: (...sources: ComponentSlotStylesInput<{}, {}>[]) => ComponentSlotStylesPrepared<{}, {}>;
/**
 ...
 */
export declare const mergeThemeVariables: (...sources: ThemeComponentVariablesInput[]) => ThemeComponentVariablesPrepared;
/**
 ...
 */
export declare const mergeThemeStyles: (...sources: ThemeComponentStylesInput[]) => ThemeComponentStylesPrepared;
...
declare const mergeThemes: (...themes: ThemeInput[]) => ThemePrepared;
