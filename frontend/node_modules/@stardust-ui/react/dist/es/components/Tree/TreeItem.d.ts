...
declare class TreeItem extends UIComponent<WithAsProp<TreeItemProps>, TreeItemState> {
    ...
    static defaultProps: {
        as: string;
        accessibility: Accessibility<import("../../lib/accessibility/Behaviors/Tree/treeItemBehavior").TreeItemBehaviorProps>;
    };
    state: {
        hasSubtree: boolean;
        treeSize: number;
    ...
    renderContent(): React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)>) | (new (props: any) => React.Component<any, any, any>)>;
