...
import { UIComponent, UIComponentProps, ContentComponentProps, ChildrenComponentProps, ColorComponentProps, ShorthandFactory } from '../../lib';
import { Accessibility } from '../../lib/accessibility/types';
import { ShorthandCollection, ShorthandValue, WithAsProp } from '../../types';
import { ToolbarItemProps } from './ToolbarItem';
import { BoxProps } from '../Box/Box';
import * as PropTypes from 'prop-types';
export declare type ToolbarItemShorthandKinds = 'divider' | 'item' | 'group' | 'toggle' | 'custom';
...
export interface ToolbarProps extends UIComponentProps, ContentComponentProps, ChildrenComponentProps, ColorComponentProps {
    ...
    onReduceItems?: (currentItems: ShorthandCollection<ToolbarItemProps, ToolbarItemShorthandKinds>, measures: OverflowMeasures[]) => ShorthandCollection<ToolbarItemProps, ToolbarItemShorthandKinds> | null;
...
declare class Toolbar extends UIComponent<WithAsProp<ToolbarProps>, ToolbarState> {
    ...
    static propTypes: {
        ...
        onReduceItems: PropTypes.Requireable<(...args: any[]) => any>;
        measurement: (props: Record<string, any>, propName: string, componentName: string, ...args: any[]) => any;
        wrapper: (props: Record<string, any>, propName: string, componentName: string, ...args: any[]) => any;
    ...
    static CustomItem: {
        <Tag>(x: {
            as: Tag;
        } & import("./ToolbarCustomItem").ToolbarCustomItemProps & {
            [K: string]: any;
        }): JSX.Element;
        (x: {
            accessibility?: Accessibility<any>;
            ...
            focusable?: boolean;
            onClick?: never;
            onFocus?: import("../../types").ComponentEventHandler<import("./ToolbarCustomItem").ToolbarCustomItemProps>;
            onBlur?: import("../../types").ComponentEventHandler<import("./ToolbarCustomItem").ToolbarCustomItemProps>;
            className?: string;
        ...
        create: ShorthandFactory<import("./ToolbarCustomItem").ToolbarCustomItemProps>;
        _handledPropsCache: string[];
    };
    static Divider: {
        <Tag>(x: {
            as: Tag;
        } & import("./ToolbarDivider").ToolbarDividerProps & {
            [K: string]: any;
        }): JSX.Element;
        (x: {
            accessibility?: Accessibility<any>;
        ...
        handledProps: string[];
        unhandledProps: string[];
        create: ShorthandFactory<import("./ToolbarDivider").ToolbarDividerProps>;
        _handledPropsCache: string[];
    };
    static Item: {
        <Tag>(x: {
        ...
        (x: {
            ...
            active?: boolean;
            disabled?: boolean;
            icon?: ShorthandValue<import("../..").IconProps>;
            menu?: string | number | boolean | React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)>) | (new (props: any) => React.Component<any, any, any>)> | React.ReactNodeArray | React.ReactPortal | import("../../types").Props<import("./ToolbarMenu").ToolbarMenuProps> | ShorthandValue<import("./ToolbarMenuItem").ToolbarMenuItemProps & {
                kind?: ToolbarItemShorthandKinds;
            }>[];
            menuOpen?: boolean;
            onMenuOpenChange?: import("../../types").ComponentEventHandler<ToolbarItemProps>;
            onClick?: import("../../types").ComponentEventHandler<ToolbarItemProps>;
            onFocus?: import("../../types").ComponentEventHandler<ToolbarItemProps>;
            onBlur?: import("../../types").ComponentEventHandler<ToolbarItemProps>;
            popup?: string | Pick<import("../..").PopupProps, "open" | "content" | "inline" | "on" | "className" | "position" | "accessibility" | "offset" | "autoFocus" | "styles" | "variables" | "align" | "unstable_pinned" | "pointing" | "trapFocus" | "target" | "mountNode" | "defaultOpen" | "mountDocument" | "mouseLeaveDelay" | "onOpenChange" | "renderContent" | "tabbableTrigger" | "contentRef">;
            wrapper?: ShorthandValue<BoxProps>;
            className?: string;
            design?: import("../..").ComponentDesign;
            styles?: import("../..").ComponentSlotStyle<any, any>;
        ...
        slotClassNames: import("./ToolbarItem").ToolbarItemSlotClassNames;
        _handledPropsCache: string[];
    };
    static Menu: {
        <Tag>(x: {
            as: Tag;
        } & import("./ToolbarMenu").ToolbarMenuProps & {
            [K: string]: any;
        }): JSX.Element;
        (x: {
            items?: ShorthandValue<import("./ToolbarMenuItem").ToolbarMenuItemProps & {
                kind?: import("../..").MenuShorthandKinds;
            }>[];
            onItemClick?: import("../../types").ComponentEventHandler<import("./ToolbarMenuItem").ToolbarMenuItemProps>;
            className?: string;
            design?: import("../..").ComponentDesign;
            styles?: import("../..").ComponentSlotStyle<any, any>;
            variables?: any;
        ...
        handledProps: string[];
        unhandledProps: string[];
        create: ShorthandFactory<import("./ToolbarMenu").ToolbarMenuProps>;
        _handledPropsCache: string[];
    };
    static MenuDivider: {
        <Tag>(x: {
            as: Tag;
        } & import("./ToolbarMenuDivider").ToolbarMenuDividerProps & {
            [K: string]: any;
        }): JSX.Element;
        (x: {
            accessibility?: Accessibility<any>;
        ...
        handledProps: string[];
        unhandledProps: string[];
        create: ShorthandFactory<import("./ToolbarMenuDivider").ToolbarMenuDividerProps>;
        _handledPropsCache: string[];
    };
    static MenuItem: {
        <Tag>(x: {
            as: Tag;
        } & import("./ToolbarMenuItem").ToolbarMenuItemProps & {
            [K: string]: any;
        }): JSX.Element;
        (x: {
            accessibility?: Accessibility<any>;
            ...
            disabled?: boolean;
            icon?: ShorthandValue<import("../..").IconProps>;
            onClick?: import("../../types").ComponentEventHandler<import("./ToolbarMenuItem").ToolbarMenuItemProps>;
            wrapper?: ShorthandValue<BoxProps>;
            className?: string;
            design?: import("../..").ComponentDesign;
            styles?: import("../..").ComponentSlotStyle<any, any>;
        ...
        handledProps: string[];
        unhandledProps: string[];
        create: ShorthandFactory<import("./ToolbarMenuItem").ToolbarMenuItemProps>;
        slotClassNames: import("./ToolbarMenuItem").ToolbarMenuItemSlotClassNames;
        _handledPropsCache: string[];
    };
    static RadioGroup: {
        <Tag>(x: {
            as: Tag;
        } & import("./ToolbarRadioGroup").ToolbarRadioGroupProps & {
            [K: string]: any;
        }): JSX.Element;
        (x: {
            accessibility?: Accessibility<any>;
            items?: ShorthandValue<ToolbarItemProps & {
                kind?: import("../..").MenuShorthandKinds;
            }>[];
            className?: string;
            design?: import("../..").ComponentDesign;
        ...
        handledProps: string[];
        unhandledProps: string[];
        create: ShorthandFactory<import("./ToolbarRadioGroup").ToolbarRadioGroupProps>;
        _handledPropsCache: string[];
    };
    state: ToolbarState;
    wrapperRef: React.RefObject<HTMLElement>;
    hiddenToolbarRef: React.RefObject<HTMLElement>;
    animationFrameId: number;
    handleItemOverrides: (variables: any) => (predefinedProps: any) => {
        variables: import("../..").ComponentVariablesPrepared;
    };
    renderItems(items: any, variables: any): React.ReactElement<any, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)>) | (new (props: any) => React.Component<any, any, any>)>[];
    static getDerivedStateFromProps(props: ToolbarProps, state: ToolbarState): {
        initialItems: ShorthandValue<ToolbarItemProps & {
            kind?: ToolbarItemShorthandKinds;
        }>[];
        currentItems: ShorthandValue<ToolbarItemProps & {
            kind?: ToolbarItemShorthandKinds;
        }>[];
        stableItems: ShorthandValue<ToolbarItemProps & {
            kind?: ToolbarItemShorthandKinds;
        }>[];
        stable: boolean;
    };
    ...
    afterComponentRendered(): void;
    measureOverflow(): {
        fits: boolean;
        measures: OverflowMeasures[];
    };
    onResize: (newWidth: any, newHeight: any) => void;
    renderComponent({ accessibility, ElementType, classes, variables, unhandledProps, }: {
        accessibility: any;
        ElementType: any;
        classes: any;
        variables: any;
...
declare const _default: {
    ...
    (x: {
        ...
        onReduceItems?: (currentItems: ShorthandValue<ToolbarItemProps & {
            kind?: ToolbarItemShorthandKinds;
        }>[], measures: OverflowMeasures[]) => ShorthandValue<ToolbarItemProps & {
            kind?: ToolbarItemShorthandKinds;
        }>[];
        measurement?: ShorthandValue<BoxProps>;
        wrapper?: ShorthandValue<BoxProps>;
    ...
    contextType: any;
    displayName: string;
    getDerivedStateFromProps: typeof Toolbar.getDerivedStateFromProps;
    className: string;
    handledProps: string[];
    Divider: {
        <Tag>(x: {
    ...
    slotClassNames: ToolbarSlotClassNames;
    _handledPropsCache: string[];
    Item: {
        <Tag>(x: {
            as: Tag;
