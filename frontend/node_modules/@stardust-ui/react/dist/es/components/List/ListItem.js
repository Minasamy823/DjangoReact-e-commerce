...
function (_UIComponent) {
  ...
  _createClass(ListItem, [{
    ...
    value: function renderComponent(_ref) {
      ...
      var headerPart = hasHeaderPart && React.createElement(React.Fragment, null, React.createElement(Flex.Item, {
        grow: true
      }, headerElement), headerMediaElement);
      var hasContentPart = !!(contentElement || contentMediaElement);
      var contentPart = hasContentPart && React.createElement(React.Fragment, null, React.createElement(Flex.Item, {
        grow: true
      ...
      }, accessibility.attributes.root, unhandledProps, applyAccessibilityKeyHandlers(accessibility.keyHandlers.root, unhandledProps)), mediaElement, React.createElement(Flex.Item, {
        grow: true
      }, React.createElement(Flex, {
        className: ListItem.slotClassNames.main,
        column: hasBothParts,
        styles: styles.main
      }, hasBothParts ? React.createElement(Flex, null, headerPart) : headerPart, hasBothParts ? React.createElement(Flex, null, contentPart) : contentPart)), endMediaElement);
    }
  }]);
