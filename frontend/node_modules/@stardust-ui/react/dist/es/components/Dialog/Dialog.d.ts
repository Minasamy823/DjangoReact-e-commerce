...
declare class Dialog extends AutoControlledComponent<WithAsProp<DialogProps>, DialogState> {
    ...
    static defaultProps: {
        accessibility: Accessibility<{
            headerId?: string;
            contentId?: string;
        } & import("../../lib/accessibility/Behaviors/Popup/popupBehavior").PopupBehaviorProps & Pick<import("../../lib/accessibility/types").AccessibilityAttributes, "aria-describedby" | "aria-label" | "aria-labelledby">>;
        actions: {};
        backdrop: boolean;
        closeOnOutsideClick: boolean;
        overlay: {};
