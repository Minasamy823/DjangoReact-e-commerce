...
import { FocusTrapZone, AutoFocusZone } from '../../lib/accessibility/FocusZone';
...
function (_UIComponent) {
  ...
  _createClass(PopupContent, [{
    ...
    value: function renderComponent(_ref) {
      ...
      var popupContent = React.createElement(React.Fragment, null, pointing && React.createElement(Ref, {
        innerRef: pointerRef
      }, Box.create({}, {
        defaultProps: {
