...
import { UIComponentProps, ContentComponentProps, ChildrenComponentProps, SizeValue, ShorthandFactory } from '../../lib';
    ...
    Group: {
        ...
        (x: {
            ...
            buttons?: ShorthandValue<ButtonProps & {
                kind?: never; /** A button can be formatted to show different levels of emphasis. */
            }>[];
            circular?: boolean;
            className?: string;
            design?: import("../..").ComponentDesign;
        ...
        handledProps: string[];
        unhandledProps: string[];
        create: ShorthandFactory<import("./ButtonGroup").ButtonGroupProps>;
        _handledPropsCache: string[];
    };
};
/**
