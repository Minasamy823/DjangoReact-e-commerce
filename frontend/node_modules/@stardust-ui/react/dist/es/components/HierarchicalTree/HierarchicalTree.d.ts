...
import { HierarchicalTreeItemProps } from './HierarchicalTreeItem';
import { AutoControlledComponent, UIComponentProps, ChildrenComponentProps, ShorthandFactory } from '../../lib';
import { ShorthandValue, ShorthandRenderFunction, ShorthandCollection, ComponentEventHandler } from '../../types';
...
declare const _default: {
    ...
    (x: {
        ...
        defaultActiveIndex?: number | number[];
        exclusive?: boolean;
        items?: ShorthandValue<HierarchicalTreeItemProps & {
            kind?: never;
        }>[];
        renderItemTitle?: ShorthandRenderFunction;
        onActiveIndexChange?: ComponentEventHandler<HierarchicalTreeProps>;
    ...
    create: ShorthandFactory<HierarchicalTreeProps>;
    slotClassNames: HierarchicalTreeSlotClassNames;
