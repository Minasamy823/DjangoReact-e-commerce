...
import { AutoControlledComponent, childrenExist, createShorthandFactory, doesNodeContainClick, commonPropTypes, isFromKeyboard, rtlTextContainer, applyAccessibilityKeyHandlers } from '../../lib';
...
function (_AutoControlledCompon) {
  ...
  _createClass(MenuItem, [{
    ...
    value: function renderComponent(_ref) {
      ...
      var menuItemInner = childrenExist(children) ? children : React.createElement(Ref, {
      ...
      }, applyAccessibilityKeyHandlers(accessibility.keyHandlers.root, unhandledProps)), icon && Icon.create(this.props.icon, {
        defaultProps: {
        ...
        element: content
      }), menu && Icon.create(indicatorWithDefaults, {
        defaultProps: {
...
_defineProperty(MenuItem, "className", 'ui-menu__item');

_defineProperty(MenuItem, "slotClassNames", {
