...
import { AutoControlledComponent, partitionHTMLProps, commonPropTypes, applyAccessibilityKeyHandlers } from '../../lib';
...
_defineProperty(Input, "className", 'ui-input');

_defineProperty(Input, "displayName", 'Input');

_defineProperty(Input, "slotClassNames", void 0);
