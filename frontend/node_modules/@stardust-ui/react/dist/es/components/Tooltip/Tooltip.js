...
import { applyAccessibilityKeyHandlers, childrenExist, AutoControlledComponent, commonPropTypes, isFromKeyboard, setWhatInputSource, getOrGenerateIdFromShorthand } from '../../lib';
...
function (_AutoControlledCompon) {
  ...
  function Tooltip() {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderPopperChildren", function (tooltipPositionClasses, rtl, accessibility, _ref) {
      ...
      var tooltipContent = Tooltip.Content.create(content, {
        defaultProps: Object.assign({}, tooltipContentAttributes, {
          placement: placement,
          pointing: pointing,
  ...
  _createClass(Tooltip, [{
    ...
    value: function renderComponent(_ref2) {
      ...
      var triggerElement = React.Children.only(childrenExist(children) ? children : trigger);
