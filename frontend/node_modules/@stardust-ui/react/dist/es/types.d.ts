...
export declare type ShorthandRenderFunction = (Component: React.ReactType, props: Props) => React.ReactElement<any>;
export declare type ShorthandRenderer<P> = (value: ShorthandValue<P>, renderTree?: ShorthandRenderFunction) => React.ReactElement<any>;
