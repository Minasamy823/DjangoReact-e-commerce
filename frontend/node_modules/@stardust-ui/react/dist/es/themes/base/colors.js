...
export var colors = Object.assign({}, emphasisAndNaturalColors, contextualColors, {
  black: '#000',
  white: '#fff'
});
export var colorScheme = Object.assign({}, _mapValues(emphasisAndNaturalColors, function (colorVariants, colorName) {
  return {
