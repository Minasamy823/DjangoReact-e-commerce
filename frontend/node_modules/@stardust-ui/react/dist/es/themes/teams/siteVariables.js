...
export var shadowLevel2 = '0 .4rem 0.7rem -0.1rem rgba(0, 0, 0, .1)';
export var shadowLevel3 = '0 .8rem 1rem -0.2rem rgba(0, 0, 0, .1)';
export var shadowLevel4 = '0 .6rem 1.8rem -0.4rem rgba(0, 0, 0, .1)';
export var shadowLevel1Darker = '0 .2rem .4rem -.075rem rgba(0, 0, 0, 0.5)'; //
// FONT SIZES
//
...
export var bodyFontFamily = '"Segoe UI", "Helvetica Neue", "Apple Color Emoji", "Segoe UI Emoji", Helvetica, Arial, sans-serif';
