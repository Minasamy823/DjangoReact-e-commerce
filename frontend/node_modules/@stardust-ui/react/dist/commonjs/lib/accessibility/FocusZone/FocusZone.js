...
var _FocusZone = require("./FocusZone.types");
...
function (_React$Component) {
  (0, _inherits2.default)(FocusZone, _React$Component);
  (0, _createClass2.default)(FocusZone, null, [{
    key: "getOuterZones",
  ...
  function FocusZone(props) {
    ...
    (0, _classCallCheck2.default)(this, FocusZone);
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(FocusZone).call(this, props));
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "_root", {
      current: null
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "_id", void 0);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "_activeElement", void 0);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "_lastIndexPath", void 0);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "_isParked", false);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "_parkedTabIndex", void 0);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "_defaultFocusElement", void 0);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "_focusAlignment", void 0);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "_isInnerZone", void 0);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "_processingTabKey", void 0);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "windowElement", void 0);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "setRef", function (elem) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "_onFocus", function (ev) {
      ...
      if (isImmediateDescendant) {
        ...
        while (parentElement && parentElement !== _this._root.current) {
          ...
          parentElement = (0, _focusUtilities.getParent)(parentElement);
        }
      } // If an inner focusable element should be focused when FocusZone container receives focus


      if (shouldFocusInnerElementWhenReceivedFocus && ev.target === _this._root.current) {
        var maybeElementToFocus = defaultTabbableElement && defaultTabbableElement(_this._root.current); // try to focus defaultTabbable element
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "_onKeyDownCapture", function (ev) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "_onMouseDown", function (ev) {
      ...
      while (target && target !== _this._root.current) {
        path.push(target);
        target = (0, _focusUtilities.getParent)(target);
      }
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "_onKeyDown", function (ev) {
      ...
      var doc = (0, _focusUtilities.getDocument)(_this._root.current);
      ...
      if (shouldEnterInnerZone && shouldEnterInnerZone(ev) && _this.isImmediateDescendantOfZone(ev.target)) {
        ...
        switch (keyboardKey.getCode(ev)) {
          ...
          case keyboardKey.ArrowLeft:
            if (direction !== _FocusZone.FocusZoneDirection.vertical) {
          ...
          case keyboardKey.ArrowUp:
            if (direction !== _FocusZone.FocusZoneDirection.horizontal) {
              _this.preventDefaultWhenHandled(ev);
          ...
          case keyboardKey.Tab:
            if (_this.props.handleTabKey === _FocusZone.FocusZoneTabbableElements.all || _this.props.handleTabKey === _FocusZone.FocusZoneTabbableElements.inputOnly && _this.isElementInput(ev.target)) {
              var focusChanged = false;
              _this._processingTabKey = true;

              if (direction === _FocusZone.FocusZoneDirection.vertical) {
                focusChanged = ev.shiftKey ? _this.moveFocusUp() : _this.moveFocusDown();
              } else if (direction === _FocusZone.FocusZoneDirection.horizontal || direction === _FocusZone.FocusZoneDirection.bidirectional) {
  ...
  (0, _createClass2.default)(FocusZone, [{
    ...
    value: function componentDidMount() {
      ...
      this.windowElement = (0, _focusUtilities.getWindow)(this._root.current);
      var parentElement = (0, _focusUtilities.getParent)(this._root.current);
    ...
    value: function componentDidUpdate() {
      ...
      if (doc && this._lastIndexPath && (doc.activeElement === doc.body || this.props.restoreFocusFromRoot && doc.activeElement === this._root.current)) {
    ...
    value: function render() {
      ...
      var unhandledProps = (0, _getUnhandledProps.default)({
        handledProps: (0, _toConsumableArray2.default)((0, _keys2.default)(FocusZone.propTypes))
      }, this.props); // Note, right before rendering/reconciling proceeds, we need to record if focus
    ...
    value: function focus() {
      ...
      if (this._root.current) {
        if (!forceIntoFirstElement && this._root.current.getAttribute(_focusUtilities.IS_FOCUSABLE_ATTRIBUTE) === 'true' && this._isInnerZone) {
        ...
        if (!forceIntoFirstElement && this._activeElement && this._root.current.contains(this._activeElement) && (0, _focusUtilities.isElementTabbable)(this._activeElement)) {
    ...
    value: function evaluateFocusBeforeRender() {
      ...
      if (focusedElement !== this._root.current) {
        var shouldRestoreFocus = this._root.current.contains(focusedElement);
     ...
     * TODO
     */
    value: function tryInvokeClickForFocusable(onTarget) {
      return false;
    }
    /**
    ...
    key: "moveFocus",
    value: function moveFocus(isForward, getDistanceFromCenter, ev) {
      var useDefaultWrap = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
      var element = this._activeElement;
      var candidateDistance = -1;
      var candidateElement = undefined;
      var changedFocus = false;
      var isBidirectional = this.props.direction === _FocusZone.FocusZoneDirection.bidirectional;
    ...
    value: function moveFocusLeft() {
      ...
      if (this.moveFocus(this.props.isRtl, function (activeRect, targetRect) {
        ...
        if (topBottomComparison && targetRect.right <= activeRect.right && _this2.props.direction !== _FocusZone.FocusZoneDirection.vertical) {
    ...
    value: function moveFocusRight() {
      ...
      if (this.moveFocus(!this.props.isRtl, function (activeRect, targetRect) {
        ...
        if (topBottomComparison && targetRect.left >= activeRect.left && _this3.props.direction !== _FocusZone.FocusZoneDirection.vertical) {
    ...
    value: function setFocusAlignment(element, isHorizontal, isVertical) {
      if (this.props.direction === _FocusZone.FocusZoneDirection.bidirectional && (!this._focusAlignment || isHorizontal || isVertical)) {
    ...
    value: function getOwnerZone(element) {
      var doc = (0, _focusUtilities.getDocument)(this._root.current);
      var parentElement = (0, _focusUtilities.getParent)(element);
    ...
    value: function updateTabIndexes(onElement) {
      ...
      for (var childIndex = 0; childNodes && childIndex < childNodes.length; childIndex++) {
        ...
        if (!(0, _focusUtilities.isElementFocusZone)(child)) {
          ...
          if (child.getAttribute && child.getAttribute(_focusUtilities.IS_FOCUSABLE_ATTRIBUTE) === 'false') {
        ...
        } else if (child.getAttribute(_focusUtilities.IS_FOCUSABLE_ATTRIBUTE) === 'true') {
...
exports.default = FocusZone;
(0, _defineProperty2.default)(FocusZone, "propTypes", {
...
(0, _defineProperty2.default)(FocusZone, "defaultProps", {
  isCircularNavigation: false,
  direction: _FocusZone.FocusZoneDirection.bidirectional,
  as: 'div',
  preventDefaultWhenHandled: true
});
(0, _defineProperty2.default)(FocusZone, "displayName", 'FocusZone');
(0, _defineProperty2.default)(FocusZone, "className", 'ms-FocusZone');