  ...
  return {
    attributes: {
      root: Object.assign({}, !props.hasSubtree && (_ref = {
        tabIndex: -1
      }, (0, _defineProperty2.default)(_ref, _focusUtilities.IS_FOCUSABLE_ATTRIBUTE, true), (0, _defineProperty2.default)(_ref, "role", 'treeitem'), _ref))
    },
    keyActions: {
      root: {
        performClick: {
...
var _default = hierarchicalTreeTitleBehavior;
