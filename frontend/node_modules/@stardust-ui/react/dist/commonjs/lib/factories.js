...
var CREATE_SHORTHAND_DEFAULT_OPTIONS = {
  defaultProps: {},
  overrideProps: {},
  generateKey: true // It's only necessary to map props that don't use 'children' as value ('children' is the default)
...
function createShorthand(_ref) {
  var allowsJSX = _ref.allowsJSX,
      ...
      options = _ref$options === void 0 ? CREATE_SHORTHAND_DEFAULT_OPTIONS : _ref$options;
...
function createShorthandFromValue(_ref3) {
  ...
  overrideProps = typeof overrideProps === 'function' ? overrideProps(Object.assign({}, defaultProps, usersProps)) : overrideProps || {}; // Merge props
