...
var createPopper = function createPopper(reference, popper, options) {
  return new (_PopperJS.default || _PopperJS)(reference, popper, options);
};
/**
...
var Popper = function Popper(props) {
  ...
  var createInstance = React.useCallback(function () {
    ...
    var popperHasScrollableParent = (0, _getScrollParent.default)(contentRef.current) !== document.body;
