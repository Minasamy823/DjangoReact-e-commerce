...
function (_AutoControlledCompon) {
  ...
  function Menu() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "renderItems", function (styles, variables, accessibility) {
      ...
      var itemsCount = (0, _filter2.default)(items, function (item) {
        return (0, _lib.getKindProp)(item, 'item') !== 'divider';
      }).length;
      var itemPosition = 0;
      ...
      return (0, _map2.default)(items, function (item, index) {
        ...
        var kind = (0, _lib.getKindProp)(item, 'item');
  ...
  (0, _createClass2.default)(Menu, [{
    ...
    value: function renderComponent(_ref) {
      ...
      }), (0, _lib.childrenExist)(children) ? children : this.renderItems(styles, variables, accessibility));
    }
  }]);
  return Menu;
...
(0, _defineProperty2.default)(Menu, "className", 'ui-menu');
(0, _defineProperty2.default)(Menu, "slotClassNames", {
  divider: "".concat(Menu.className, "__divider"),
  item: "".concat(Menu.className, "__item")
});
(0, _defineProperty2.default)(Menu, "create", void 0);
(0, _defineProperty2.default)(Menu, "propTypes", Object.assign({}, _lib.commonPropTypes.createCommon({
  content: false
}), {
...
Menu.create = (0, _lib.createShorthandFactory)({
  Component: Menu,
