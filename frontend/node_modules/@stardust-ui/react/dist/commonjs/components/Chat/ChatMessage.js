  ...
  (0, _createClass2.default)(ChatMessage, [{
    ...
    value: function renderActionMenu(actionMenu, styles) {
      ...
      var actionMenuElement = _Menu.default.create(actionMenu, {
        defaultProps: (_defaultProps = {}, (0, _defineProperty2.default)(_defaultProps, _FocusZone.IS_FOCUSABLE_ATTRIBUTE, true), (0, _defineProperty2.default)(_defaultProps, "accessibility", _accessibility.menuAsToolbarBehavior), (0, _defineProperty2.default)(_defaultProps, "className", ChatMessage.slotClassNames.actionMenu), (0, _defineProperty2.default)(_defaultProps, "styles", styles.actionMenu), _defaultProps)
      });
