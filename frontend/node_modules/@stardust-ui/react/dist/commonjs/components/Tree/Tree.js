...
function (_AutoControlledCompon) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "handleTreeItemOverrides", function (predefinedProps) {
      return {
        ...
        onFocusFirstChild: function onFocusFirstChild(e, treeItemProps) {
          ...
          var elementToBeFocused = (0, _focusUtilities.getNextElement)(_this.treeRef.current, currentElement.current);
  ...
  (0, _createClass2.default)(Tree, [{
    ...
    value: function renderComponent(_ref) {
      ...
      }), unhandledProps, (0, _lib.applyAccessibilityKeyHandlers)(accessibility.keyHandlers.root, unhandledProps)), (0, _lib.childrenExist)(children) ? children : renderedItems ? renderedItems(this.renderContent()) : this.renderContent()));
    }
  }], [{
