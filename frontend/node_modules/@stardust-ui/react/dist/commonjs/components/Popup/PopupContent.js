...
function (_UIComponent) {
  ...
  (0, _createClass2.default)(PopupContent, [{
    ...
    value: function renderComponent(_ref) {
      ...
      var popupContent = React.createElement(React.Fragment, null, pointing && React.createElement(_reactComponentRef.Ref, {
        innerRef: pointerRef
      }, _Box.default.create({}, {
        defaultProps: {
      ...
      if (trapFocus) {
        ...
        return React.createElement(_FocusZone.FocusTrapZone, focusTrapZoneProps, popupContent);
      }
      ...
      if (autoFocus) {
        ...
        return React.createElement(_FocusZone.AutoFocusZone, autoFocusZoneProps, popupContent);
      }
