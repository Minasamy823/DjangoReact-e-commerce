...
function (_UIComponent) {
  ...
  (0, _createClass2.default)(FormField, [{
    ...
    value: function renderComponent(_ref) {
      ...
      }, accessibility.attributes.root, unhandledProps), (0, _lib.childrenExist)(children) ? children : content);
    }
  }]);
  return FormField;
}(_lib.UIComponent);
...
(0, _defineProperty2.default)(FormField, "className", 'ui-form__field');
(0, _defineProperty2.default)(FormField, "create", void 0);
(0, _defineProperty2.default)(FormField, "propTypes", Object.assign({}, _lib.commonPropTypes.createCommon({
  content: false
}), {
...
FormField.create = (0, _lib.createShorthandFactory)({
  Component: FormField,
  mappedProp: 'label'
});
/**
